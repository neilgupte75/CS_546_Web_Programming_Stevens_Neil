...
async function runSetup() {
  ...
  const darkKnightRises = makeDoc('Batman: The Dark Knight Rises', 5, 2012, 'Christopher Nolan');
  ...
  const kingsman = makeDoc('Kingsman: The Secret Service', 3.2, 2015, 'Matthew Vaughn');
  kingsman.cast.push(
    'Colin Firth',
    'Samuel L. Jackson',
    'Mark Strong',
